                    ...
                    <li class="emms__calendar__list__item">
                        <div class="emms__calendar__list__item__card">
                            ...
                            <div class="emms__calendar__list__item__card__description">
                                ...
                                <?php endif; ?>
                                <?php if (($speaker['exposes'] === "conference") && ($speaker['slug'])) : ?>
                                ...
                                <?php if (($speaker['exposes'] === "networking") || ($speaker['exposes'] === "workshop")) : ?>
                                    <a href="<?= $speaker['youtube'] ?>" class="emms__cta  hidden--vip">HAZTE VIP</a>
                                <?php endif; ?>
                                <?php if (($speaker['exposes'] === "networking") || ($speaker['exposes'] === "workshop")) : ?>
                                    <a href="<?= $speaker['youtube'] ?>" class="emms__cta  show--vip">VIDEO PRONTO DISPONIBLE</a>
                                <?php endif; ?>
                                <?php if (($isSpeakerExposeDebate)) : ?>
                                    <a href="<?= $speaker['youtube'] ?>" class="emms__cta">VER MESA DE DEBATE</a>
                                <?php endif; ?>
                            </div>
