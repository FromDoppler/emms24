    ...
    <main>
        ...
        <section class="emms__hero-conference emms__hero-conference--bio">
            <div class="emms__container--lg">
                <?php include($_SERVER['DOCUMENT_ROOT'] . '/components/digital-trends/post/speaker-interna/event-recorded.php') ?>
        ...
        <?php include($_SERVER['DOCUMENT_ROOT'] . '/components/digital-trends/post/speaker-interna/promo-vip.php') ?>
