...
{
 $sql_query="SELECT * FROM aliados_starter WHERE id=".$_GET['view_id'];
...
<tr>
 ...
 <tr>
   ...
   <th colspan="5"> <?php echo $fetched_row['title'] ?></th>
</tr>
 <tr>
    <td>
   <label for="description_card" class="form-label">Description_card:</label>
   </td>
   <th colspan="5"> <?php echo $fetched_row['description_card'] ?></th>
</tr>
 <tr>
    <td>
   <label for="slug" class="form-label">Slug:</label>
   </td>
   <th colspan="5"> <?php echo $fetched_row['slug'] ?></th>
</tr>
 <tr>
    <td>
   <label for="orden_card" class="form-label">Orden_card:</label>
   </td>
   <th colspan="5"> <?php echo $fetched_row['orden_card'] ?></th>
</tr>
 <tr>
    <td>
...
<tr>
 ...
 <tr>
   ...
   <th colspan="5"> <?php echo $fetched_row['alt_image_landing'] ?></th>
</tr>
 <tr>
    <td>
