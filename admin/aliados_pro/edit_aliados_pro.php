...
if (isset($_POST['btn-update'])) {
    ...
    $sql_query = "UPDATE aliados_pro SET `name`='$name',`image_home`='$image_home',`alt_image_home`='$alt_image_home',`link_site`='$link_site',`orden_home`='$orden_home',`title`='$title',`description_card`='$description_card',`slug`='$slug',`orden_card`='$orden_card',`description`='$description',`image_landing`='$image_landing',`alt_image_landing`='$alt_image_landing',`youtube`='$youtube',`image_youtube`='$image_youtube',`alt_image_youtube`='$alt_image_youtube',`title_magnet`='$title_magnet',`description_magnet`='$description_magnet',`link_magnet`='$link_magnet',`title_learnmore`='$title_learnmore',`description_learnmore`='$description_learnmore',`link_learnmore`='$link_learnmore' WHERE id=" . $_GET['edit_id'];
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="file" value="<?= $fetched_row['image_home'] ?>" class="form-control" id="image_home" name="image_home">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" value="<?= $fetched_row['alt_image_home'] ?>" class="form-control" id="alt_image_home" name="alt_image_home">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" value="<?= $fetched_row['link_site'] ?>" class="form-control" id="link_site" name="link_site">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" value="<?= $fetched_row['orden_home'] ?>" class="form-control" id="orden_home" name="orden_home">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" value="<?= $fetched_row['title'] ?>" class="form-control" id="title" name="title">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" value="<?= $fetched_row['description_card'] ?>" class="form-control" id="description_card" name="description_card">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" value="<?= $fetched_row['orden_card'] ?>" class="form-control" id="orden_card" name="orden_card">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($fetched_row['image_landing']) : ?>
                                    ...
                                    <input type="file" value="<?= $fetched_row['image_landing'] ?>" class="form-control" id="image_landing" name="image_landing">
                                <?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" value="<?= $fetched_row['alt_image_landing'] ?>" class="form-control" id="alt_image_landing" name="alt_image_landing">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } ?>
                                <input type="file" value="<?= $fetched_row['image_youtube'] ?>" class="form-control" id="image_youtube" name="image_youtube">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" value="<?= $fetched_row['alt_image_youtube'] ?>" class="form-control" id="alt_image_youtube" name="alt_image_youtube">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" value="<?= $fetched_row['title_magnet'] ?>" class="form-control" id="title_magnet" name="title_magnet">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" value="<?= $fetched_row['link_magnet'] ?>" class="form-control" id="link_magnet" name="link_magnet">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" value="<?= $fetched_row['title_learnmore'] ?>" class="form-control" id="title_learnmore" name="title_learnmore">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" value="<?= $fetched_row['link_learnmore'] ?>" class="form-control" id="link_learnmore" name="link_learnmore">
                            </td>
                        </tr>
                        <tr>
                            <td>
